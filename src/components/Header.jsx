			...
			<div id="top-header">
				<div className="container d-flex flex-row justify-content-between">
					<ul className="header-links pull-left">
						<li><a href="/"><i className="fa fa-phone"></i> +50931459861</a></li>
						<li><a href="/"><i class="bi bi-envelope"></i> Duckensjacquet@gmail.com</a></li>
						<li><a href="/"><i className="fa fa-map-marker"></i> Port-au-prince, Hait</a></li>
					</ul>
					<ul className="header-links pull-right text-end">
						<li><a href="/"><i className="fa fa-dollar"></i> USD</a></li>
						<li><a href="/"><i class="bi bi-person-circle"></i> My Account</a></li>
					</ul>
				</div>
			</div>
